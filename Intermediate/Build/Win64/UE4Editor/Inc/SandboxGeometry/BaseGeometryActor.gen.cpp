...
// Cross Module References
	...
	SANDBOXGEOMETRY_API UEnum* Z_Construct_UEnum_SandboxGeometry_EMovementType();
...
// End Cross Module References
	struct Z_Construct_UDelegateFunction_SandboxGeometry_OnColorChanged__DelegateSignature_Statics
	{
		struct _Script_SandboxGeometry_eventOnColorChanged_Parms
		{
			FLinearColor Color;
			FString Name;
		};
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_SandboxGeometry_OnColorChanged__DelegateSignature_Statics::NewProp_Color_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_SandboxGeometry_OnColorChanged__DelegateSignature_Statics::NewProp_Color = { "Color", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_SandboxGeometry_eventOnColorChanged_Parms, Color), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(Z_Construct_UDelegateFunction_SandboxGeometry_OnColorChanged__DelegateSignature_Statics::NewProp_Color_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SandboxGeometry_OnColorChanged__DelegateSignature_Statics::NewProp_Color_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_SandboxGeometry_OnColorChanged__DelegateSignature_Statics::NewProp_Name_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UDelegateFunction_SandboxGeometry_OnColorChanged__DelegateSignature_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_SandboxGeometry_eventOnColorChanged_Parms, Name), METADATA_PARAMS(Z_Construct_UDelegateFunction_SandboxGeometry_OnColorChanged__DelegateSignature_Statics::NewProp_Name_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SandboxGeometry_OnColorChanged__DelegateSignature_Statics::NewProp_Name_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_SandboxGeometry_OnColorChanged__DelegateSignature_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_SandboxGeometry_OnColorChanged__DelegateSignature_Statics::NewProp_Color,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_SandboxGeometry_OnColorChanged__DelegateSignature_Statics::NewProp_Name,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_SandboxGeometry_OnColorChanged__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/BaseGeometryActor.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_SandboxGeometry_OnColorChanged__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_SandboxGeometry, nullptr, "OnColorChanged__DelegateSignature", nullptr, nullptr, sizeof(_Script_SandboxGeometry_eventOnColorChanged_Parms), Z_Construct_UDelegateFunction_SandboxGeometry_OnColorChanged__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SandboxGeometry_OnColorChanged__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_SandboxGeometry_OnColorChanged__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SandboxGeometry_OnColorChanged__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_SandboxGeometry_OnColorChanged__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_SandboxGeometry_OnColorChanged__DelegateSignature_Statics::FuncParams);
		}
	...
	static UEnum* EMovementType_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_SandboxGeometry_EMovementType, Z_Construct_UPackage__Script_SandboxGeometry(), TEXT("EMovementType"));
		}
		return Singleton;
	}
	template<> SANDBOXGEOMETRY_API UEnum* StaticEnum<EMovementType>()
	{
		return EMovementType_StaticEnum();
	}
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EMovementType(EMovementType_StaticEnum, TEXT("/Script/SandboxGeometry"), TEXT("EMovementType"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_SandboxGeometry_EMovementType_Hash() { return 3040908283U; }
	UEnum* Z_Construct_UEnum_SandboxGeometry_EMovementType()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_SandboxGeometry();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EMovementType"), 0, Get_Z_Construct_UEnum_SandboxGeometry_EMovementType_Hash(), false);
#else
...
class UScriptStruct* FGeometryData::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern SANDBOXGEOMETRY_API uint32 Get_Z_Construct_UScriptStruct_FGeometryData_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FGeometryData, Z_Construct_UPackage__Script_SandboxGeometry(), TEXT("GeometryData"), sizeof(FGeometryData), Get_Z_Construct_UScriptStruct_FGeometryData_Hash());
	}
	return Singleton;
}
template<> SANDBOXGEOMETRY_API UScriptStruct* StaticStruct<FGeometryData>()
{
	return FGeometryData::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FGeometryData(FGeometryData::StaticStruct, TEXT("/Script/SandboxGeometry"), TEXT("GeometryData"), false, nullptr, nullptr);
static struct FScriptStruct_SandboxGeometry_StaticRegisterNativesFGeometryData
{
	FScriptStruct_SandboxGeometry_StaticRegisterNativesFGeometryData()
	{
		UScriptStruct::DeferCppStructOps<FGeometryData>(FName(TEXT("GeometryData")));
	}
} ScriptStruct_SandboxGeometry_StaticRegisterNativesFGeometryData;
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FGeometryData_Statics::NewProp_MoveType = { "MoveType", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGeometryData, MoveType), Z_Construct_UEnum_SandboxGeometry_EMovementType, METADATA_PARAMS(Z_Construct_UScriptStruct_FGeometryData_Statics::NewProp_MoveType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGeometryData_Statics::NewProp_MoveType_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FGeometryData_Statics::NewProp_Color = { "Color", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGeometryData, Color), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(Z_Construct_UScriptStruct_FGeometryData_Statics::NewProp_Color_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGeometryData_Statics::NewProp_Color_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FGeometryData_Hash() { return 1831251494U; }
	DEFINE_FUNCTION(ABaseGeometryActor::execGetGeometryData)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(FGeometryData*)Z_Param__Result=P_THIS->GetGeometryData();
		P_NATIVE_END;
	}
	void ABaseGeometryActor::StaticRegisterNativesABaseGeometryActor()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "GetGeometryData", &ABaseGeometryActor::execGetGeometryData },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_ABaseGeometryActor_GetGeometryData_Statics
	{
		struct BaseGeometryActor_eventGetGeometryData_Parms
		{
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ABaseGeometryActor_GetGeometryData_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(BaseGeometryActor_eventGetGeometryData_Parms, ReturnValue), Z_Construct_UScriptStruct_FGeometryData, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ABaseGeometryActor_GetGeometryData_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ABaseGeometryActor_GetGeometryData_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ABaseGeometryActor_GetGeometryData_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/BaseGeometryActor.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ABaseGeometryActor_GetGeometryData_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ABaseGeometryActor, nullptr, "GetGeometryData", nullptr, nullptr, sizeof(BaseGeometryActor_eventGetGeometryData_Parms), Z_Construct_UFunction_ABaseGeometryActor_GetGeometryData_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ABaseGeometryActor_GetGeometryData_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ABaseGeometryActor_GetGeometryData_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ABaseGeometryActor_GetGeometryData_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ABaseGeometryActor_GetGeometryData()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_ABaseGeometryActor_GetGeometryData_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ABaseGeometryActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ABaseGeometryActor_GetGeometryData, "GetGeometryData" }, // 2301080787
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_ABaseGeometryActor_Statics::NewProp_OnColorChanged = { "OnColorChanged", nullptr, (EPropertyFlags)0x0010000010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABaseGeometryActor, OnColorChanged), Z_Construct_UDelegateFunction_SandboxGeometry_OnColorChanged__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_ABaseGeometryActor_Statics::NewProp_OnColorChanged_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABaseGeometryActor_Statics::NewProp_OnColorChanged_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ABaseGeometryActor, 2014951466);
