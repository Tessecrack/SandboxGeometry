...
#define UE_PROJECT_NAME SandboxGeometry
#define UE_TARGET_NAME SandboxGeometryEditor
#define UE_MODULE_NAME "SandboxGeometry"
...
#define SANDBOXGEOMETRY_API DLLEXPORT
